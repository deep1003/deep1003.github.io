...
## Unreadable-title and nonprofit-issuer amendment, 24 September 2026

- **Unreadable document title:** normalised exact title `Unidentified Document Analysis` is a distinct exclusion reason. Keep all eight underlying records, including seven with provider country codes, but exclude them from content and national-policy analysis. A country field does not supply readable topic evidence.
- **Sparse evidence:** 63 blank-country records had absent, punctuation-only or under-25-alphanumeric-character abstracts. One human-reviewed item, `20.500.12592/9ymqjl9`, is an excluded blog with no substantive abstract or keywords. The other 62 are held for original-source recovery. The `WEB` export type alone does not identify a blog and must not drive a genre exclusion.
- **Exact institution links:** among 4,429 blank-country documents, 616 linked to one unique organisation ID by exact publisher name. For 873 ambiguous-name records, the organisation type agreed across all candidate IDs, so only type was stored. Thirty-six had conflicting types. These are issuer metadata observations and do not fill publication country.
- **Substantive policy document, country unresolved:** `20.500.12592/5dcn13j` is the 19-page [Digital Trust Council report](https://policycommons.net/artifacts/56114081/closing-the-ai-trust-gap/57012341/). The authenticated viewer confirms issuer and AI-certification content. Policy Commons [classifies the organisation as Nonprofit](https://policycommons.net/orgs/digital-trust-council/); its [official site](https://digitaltrustcouncil.com/about) reports 501(c)(3) tax status. Keep it in the nonprofit auxiliary corpus. Store US legal registration in dedicated fields and leave publication country blank.
- **Unresolved source queue:** 449 blank-country documents have long abstracts containing explicit AI and policy expressions. They remain candidates for original-source checks. Keyword evidence is a triage signal, not a country assignment or a calibrated precision estimate.
